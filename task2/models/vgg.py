...
#  修改为相对路径导入（由于 models 和 utils 都在同一级目录下，用 ..utils）
...
class VGG_A_BatchNorm(nn.Module):
    ...
    BatchNorm layers are added after convolutions and before ReLU activations.
    """
...
if __name__ == '__main__':
    ...
    print("VGG_A_BatchNorm params:", get_number_of_parameters(VGG_A_BatchNorm()))